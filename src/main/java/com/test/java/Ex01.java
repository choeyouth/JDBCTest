...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		/*
		    ...
		    [자바 + SQL Developer ← (SQL) → Oracle Server]
			...
			- java.net.UnknownHostException: 알려진 호스트가 없습니다 (locahost)
			...
			5. 드라이버 로딩 X
			- oracle.jdbc.driver.OracleDriver //잘못된 글자 포함해서 보여줌 
